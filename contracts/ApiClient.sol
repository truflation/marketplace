...
contract ApiClient is ChainlinkClient, ConfirmedOwner {
    ...
    function doRequest(
        ...
        string memory multiplier_) public returns (bytes32 requestId) {
          return doRequestToOracle(oracleId, jobId, fee,
                                   service_, data_, keypath_,
                                   abi_, multiplier_);
    }

  function doRequestToOracle(
        address oracleId_,
        ...
        return sendChainlinkRequestTo(oracleId_, req, fee_);
    }
